...
Bis zur nächsten Sitzung sollten wir dann noch ein [Koha-Tutorial von Stephan Tetzel]( https://zefanjas.de/wie-man-koha-installiert-und-fuer-schulen-einrichtet-teil-1/) durchführen, insbesondere die Kapitel 1-3. Das ist bei mir leider daran gescheitert, dass mir der VMWare Horizon Client immer gemeldet hat, der Hostname könne nicht aufgelöst werden (trotz VPN!). Ich werde es dann nochmals versuchen - bisher hatte ich dieses Problem nie. (Stand: 1.10., Mittag) 
